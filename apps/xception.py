...
def app():
  ...
  # st.sidebar.markdown("""The application will procees an MRI scan from the user (png,  jpg or jpeg format) and will determine 
  # the type of tumor present (either Glioma, Meningioma or Pituary) or if there is no tumor at all .""")
